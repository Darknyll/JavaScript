...
//     simpsonTitle.innerText = simpson.name + " " + simpson.surname + " " + simpson.age + " ";
...
//     arrayTitle.classList.add('titleName')
//     arrayTitle.innerText = coursesArrayElement.title;
//     div.appendChild(arrayTitle);
//
//     let arrayTime = document.createElement('div');
//     arrayTime.classList.add('monTimeFlex');
//     arrayTime.innerHTML = `<div class="monTime">${coursesArrayElement.monthDuration}</div>
//                            <div class="monTime">${coursesArrayElement.hourDuration}</div>`;
//     div.appendChild(arrayTime);
//
//     coursesArrayElement.modules
//     for (let arrayModul of coursesArrayElement.modules) {
//         let divOfModul = document.createElement('div')
//         divOfModul.classList.add('modul')
//         divOfModul.innerText = arrayModul;
//         div.appendChild(divOfModul)
//     }
//
...
// div.innerText = 'Виконання завдання'
// document.body.appendChild(div)
// let divNode = div.cloneNode(true);
...
//     let arrayText = document.createElement('li');
//     arrayText.innerText = string;
//         ul.appendChild(arrayText)
// }
...
//
// let button = document.getElementById('butt').onclick = function () {
...
//
//     if (age < 18) {
//         let nePovnoAge = document.createElement('h1');
//         nePovnoAge.classList.add('text')
//         nePovnoAge.innerText = 'Ти не повнолітня';
//         document.body.appendChild(nePovnoAge)
//     } else {
//         let povnoAge = document.createElement('h1');
//         povnoAge.classList.add('text')
//         povnoAge.innerText = 'Ти повнолітня';
//         document.body.appendChild(povnoAge)
//     }
// }
...
f1.onsubmit = function (e) {
    ...
    let lineElement = document.getElementById('lineTable');
    let cellsElement = document.getElementById('cellsTable');
    let contentElement = document.getElementById('contentsTable');

    document.getElementById('butt').onclick(createTable( `${cellsElement.value}`, `${lineElement.value}`,
